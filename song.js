...
(function() {
  'use strict';
  var Playlist, Song, clean, dismantle, netRequest, resetSongs, root,
  ...
  netRequest = function(url) {
    var request;
    request = new XMLHttpRequest();
    request.open('get', url, true);
    request.addEventListener('load', (function(_this) {
      return function() {
        var songs;
        songs = JSON.parse(request.responseText);
        _this.add(songs);
        return _this.songRequest = null;
      };
    })(this));
    request.send();
  ...
  Song = function(song) {
    ...
    audio.addEventListener('playing', (function(_this) {
      return function() {
        return _this.event.fire('playing', true);
      };
    })(this));
    audio.addEventListener('pause', (function(_this) {
      return function() {
        return _this.event.fire('playing', false);
      };
    })(this));
    return audio;
  };
